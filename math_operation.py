...
def pinholeModel(height, f, altitude, theta, x1, x2, maxHighLV, maxHighHV, maxLengthLV):
    ...
    delta1 = math.degrees(math.atan(math.fabs(x1 - (height / 2)) / f))
    delta2 = math.degrees(math.atan(math.fabs(x2 - (height / 2)) / f))
